...
### 현재 모델 성능 (2026-01-02 기준, 144개 피처)
- **PR-AUC**: 0.1121 (목표: ≥0.15) ❌ (이전 0.1077 대비 +4% 개선, 베이스라인 대비 +35% 개선)
- **ROC-AUC**: 0.7174 (이전 0.7172 대비 유사)
- **Precision@10**: 0.40 (목표: ≥0.40) ✅ (이전 0.50에서 하락했으나 목표 달성)
- **Precision@20**: 0.45 (이전 0.30 대비 +50% 개선) ✅
- **경기당 알림 수 (best threshold)**: 51.30개 (목표: 10-20개) ❌ (이전 78.95개 대비 개선)
- **베이스라인 대비**: PR-AUC +35%, Precision@20 +200% 개선
