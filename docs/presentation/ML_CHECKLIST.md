...
### 현재 모델 성능 (2026-01-02 기준, 132개 피처)
- **PR-AUC**: 0.1077 (목표: ≥0.15) ❌ (이전 0.0829 대비 +30% 개선)
- **ROC-AUC**: 0.7172 (이전 0.6688 대비 개선)
- **Precision@10**: 0.50 (목표: ≥0.40) ✅ (이전 0.20 대비 +150% 개선)
- **Precision@20**: 0.30 (이전 0.15 대비 +100% 개선)
- **경기당 알림 수 (best threshold)**: 78.95개 (목표: 10-20개) ❌
- **경기당 알림 수 (threshold 0.15)**: 9.43개 ✅ (목표 범위 달성)
- **베이스라인 대비**: PR-AUC +30%, Precision@10 +150% 개선
