...
### 현재 모델 성능 (2026-01-02 기준, 150개 피처 - StatsBomb 압박 포함)
- **PR-AUC**: 0.1057 (목표: ≥0.15) ❌ (이전 0.1121 대비 -6% 하락, 베이스라인 대비 +28% 개선)
- **ROC-AUC**: 0.7167 (이전 0.7174 대비 유사)
- **Precision@10**: 0.40 (목표: ≥0.40) ✅ (목표 달성 유지)
- **Precision@20**: 0.35 (이전 0.45 대비 하락)
- **경기당 알림 수 (best threshold)**: 60.15개 (목표: 10-20개) ❌
- **경기당 알림 수 (threshold 0.15)**: 확인 필요
- **베이스라인 대비**: PR-AUC +28%, Precision@10 +100% 개선
- **압박 피처 효과**: PR-AUC 하락 (게임 매칭 부정확 가능성)
